...
export const routerLinks = [
    ...
    { showOnNavbar: true, id: "timeline", path: "/timeline", label: "Timeline", type: "route", element: <Timeline />},
    { showOnNavbar: true, id: "portfolio", path: "/portfolio", label: "Portfolio", type: "route", element: <Portfolio />},
