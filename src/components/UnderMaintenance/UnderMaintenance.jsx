      ...
      <header className="um__header">
        <div className="um__brand">
          <div className=""><img
                      ...
                      alt=""
                      className="logo-img-fluid flex max-h-[50px]"
                      style={{ filter: "brightness(0) invert(1) sepia(1) saturate(0) brightness(1.2)" }}
                    /></div>
      ...
      <main className="um__main">
        <section className="um__card">
          ...
          <p className="um__footer-text">
            Want to reach me before this goes live?{" "}
            <a href="mailto:shrutiagupta02@gmail.com">shrutiagupta02@gmail.com</a>
          </p>
        </section>
