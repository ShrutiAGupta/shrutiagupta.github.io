...
const AlbumIndividual = ({
  ...
  return (
    ...
    >
      ...
      >
        <img src={albumData.albumCoverImage} className="object-cover object-top"/>
      </div>
      <div
      ...
      >
        <div className="w-full flex flex-col">
          <div className="alb-meta">
            <div className="text-3xl md:text-5xl px-5 pt-3 pb-5">{albumName}</div>
            <div className="alb-desc">{albumData.albumDescription}</div>
          </div>

          <div className="list-none p-0 sm:min-h-auto" style={{background: albumData.albumBackground }}>
            <ul>
              {albumData.songs.map((song) => (
                ...
                >
                  ...
                  <div className="song-name flex-1 w-full pl-3 hover:cursor-pointer">{song.songName}</div>
            ...
            {currentSong && (
              <div className="player-controls w-full m-0 mx-auto p-0 px-4 ">
                ...
                <div className="flex gap-4 justify-center items-center ">
                  <button className="flex items-center justify-center bg-none border-none cursor-pointer p-2 rounded-full transition-all duration-200 ease-in-out hover:bg-gray-200 " onClick={handlePrevious} aria-label="Previous song">
                  ...
                  <button className="flex items-center justify-center bg-none border-none cursor-pointer p-2 rounded-full transition-all duration-200 ease-in-out hover:bg-gray-200" onClick={handleNext} aria-label="Next song">
