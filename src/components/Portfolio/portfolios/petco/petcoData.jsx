...
export const QUESTIONS = [
  "Is there real unmet demand, or just anecdotal frustration?",
  "Is Petco structurally advantaged vs competitors?",
  "Would customers pay for this, and at what level?",
  "Can this scale without breaking operations?",
  "Does this meaningfully move revenue or retention?",
];

export const PRIORITIES = [
  {
    category: "High-confidence, high-impact",
    description: "we did these",
    icon: FaCheckCircle,
    extraColor: "text-slate-900",
    color: "text-[#88C65A]",
    bgColor: `bg-[#f7fcf3]`,
    borderColor: "border-[#88C65A]",
  },
  {
    category: "Directional but imperfect",
    description: "we used proxies",
    icon: FaExclamationCircle,
    extraColor: "text-slate-900",
    color: "text-[#1c446c]",
    bgColor: `bg-[#C8F0FD]`,
    borderColor: "border-[#1c446c]",
  },
  {
    category: "Out of scope",
    description: "explicitly acknowledged",
    icon: FaTimesCircle,
    extraColor: "text-[#f0f0f0]",
    color: "text-white",
    bgColor: `bg-[#07101a]/40`,
    borderColor: "border-[#f0f0f0]/50",
  },
];
