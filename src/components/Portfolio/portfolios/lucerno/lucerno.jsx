...
import { THEME_COLORS, MY_IDEAS, OTHERS_IDEAS, CHECKLIST_ITEMS, RECOMMENDATIONS, VET_IMAGES, MEMBERSHIP_IMAGES, RESEARCH_DATA, PHASES, META, OBJECTIVES, DECISION_THRESHOLDS, EVALUATION_CRITERIA } from "./lucernoData";
      ...
      <div className="grid md:grid-cols-3 gap-8 px-8 py-8">
        {PHASES.map((phase, index) => {
          return (
            <div
              key={index}
              className="group relative flex px-5 pb-5 pt-5 border-2 border-solid text-white cursor-pointer transition-colors duration-300 hover:bg-white aspect-square w-full"
              style={{ borderColor: THEME_COLORS.secondary }}
            >
              <div className="relative z-10 w-full">
                {/* Default state - visible when NOT hovering */}
                <div className="items-start justify-end flex flex-col h-full group-hover:opacity-0 transition-opacity duration-300">
                  <div className="text-5xl font-bold">{index + 1}.</div>
                  <div className="text-2xl font-semibold">{phase.title}</div>
                  <div className="text-2xl font-semibold">{phase.duration}</div>
                </div>

                {/* Hover state - visible only on hover */}
                <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-start">
                  <h3 className="text-xl font-bold mb-2 text-black">Outputs</h3>
                  <div className="text-base text-black">
                    {phase.outputs.map((output, i) => (
                      <div key={i} className="mb-1">• {output}</div>
                    ))}
                  </div>
                </div>
              </div>
    ...
    <section className="relative w-full">
      ...
      <div className="sticky top-0 h-screen w-full -z-10">
        <div
          ...
          style={{
            backgroundImage: 'url("/assets/img/projects/lucerno/petco2.jpg")',
    ...
    <section className="w-full bg-white">
      ...
      >
        <div
          ...
          style={{
            background: "url('/assets/img/projects/lucerno/rec (1).png')",
            backgroundSize: "cover",
        ...
        <div className="px-10" style={{ background: THEME_COLORS.ex4 }}>
            ...
            >
              {imgblock.imgs.map((imgname, idx) => (
                ...
                >
                  <img
                    src={`/assets/img/projects/lucerno/${imgname}`} // Use backticks for template literals
                    alt="Mobile Vet Data"
      ...
      >
        <div
          ...
          style={{
            background: "url('/assets/img/projects/lucerno/rec (26).png')",
      ...
      <div className="mx-auto px-8 py-20">
        ...
        <div className="relative items-center flex flex-col">
          ...
          <div className="relative w-[60%]">
            <img
              src="/assets/img/projects/lucerno/petco3.png"
              alt="Analysis"
            ...
            {/* <motion.div
              ...
              >
                <div className="flex items-center justify-center h-full">
                  <img src="/assets/img/projects/lucerno/petco3.png" className="-rotate-90"/>
                </div>
              </motion.div> */}
  ...
  return (
    <section className="relative">
      ...
      <div
        ...
        style={{
          backgroundImage: "url('/assets/img/projects/lucerno/lucerno.png')",
          backgroundSize: "cover",
        }}
      >
        <motion.div
        ...
        >
          ...
          >
            Lucerno Dynamics: The LARA System
            {/* <span>Making Every Injection Count</span> */}
          </motion.h1>
          <motion.p
            initial={{ opacity: 1 }}
            animate={{ opacity: 1 }}
          ...
          >
            ...
            Lucerno Dynamics' Lara helps identify injection errors in seconds, evaluate their impact within minutes, and reduce their frequency within months.
          </motion.p>
        </motion.div>
      </div>
...
export default LucernoPortfolio;
