...
export const PHASES = [
  {
    ...
    duration: "Days 1-5",
    desc: [
      "Analyzed 4 customer segments and their characteristics",
      "Mapped stakeholder needs and decision-making processes",
      "Assessed competitive landscape (manual monitoring, training programs)",
      "Calculated market opportunity and ROI potential per segment",
    ],
  },
  {
    title: "Strategy Development",
    outputs: [
      "Target customer selection with rationale",
      "Financial model and projections",
      "Customer ROI calculators",
    ],
    duration: "Days 6-10",
    desc: [
      "Selected and prioritized target customer segments",
      "Built 3-year financial model and breakeven analysis",
      "Calculated customer-specific ROI by segment type",
      "Developed value propositions for each target",
    ],
  },
  {
    ...
    outputs: [
      "Sales playbook",
      "Sample customer pitches",
      "Risk assessment framework",
    ],
    duration: "Days 11-15",
    desc: [
      "Designed sales methodology and go-to-market approach",
      "Created segment-specific pitch strategies",
      "Developed objection handling and integration plans",
  ...
  },
  {
    ...
    outputs: [
      "Financial model with quarterly projections",
      "Customer ROI calculators by segment",
      "Breakeven analysis",
      "Sensitivity scenarios",
    ],
    duration: "",
    desc: [
      "Built 3-year revenue projections to reach 75 centers",
      "Calculated customer-specific ROI by segment type",
      "Validated breakeven analysis ($12M revenue × 25% margin = $3M)",
      "Performed sensitivity analysis on key assumptions",
    ],
  },
  {
    title: "Risk & Implementation Planning",
    outputs: [
    ...
    duration: "",
    desc: [
      "Identified key risks across market, operational, financial, and regulatory categories",
      "Developed mitigation strategies and contingency plans",
      "Designed workflow integration approach",
      "Structured pilot program (3 phases over 12 months)",
  ...
  },
  {
    ...
    duration: "Days 16-21",
    desc: [
      "Structured Board presentation (Strategic Framework + Sales Execution)",
      "Created visual presentation deck",
      "Practiced delivery and refined messaging",
...
export const META = [
  ...
  {
    name: "Stakeholders",
    content: "Lucerno Dynamics' Team, Professors, Competition Organizers",
  },
  {
    name: "Collaborators",
    content: "2 MBA Students, 1 MD Student",
  },
];

export const OBJECTIVES = [
  "Develop a commercial strategy to achieve breakeven ($3M investment recovery) within 3 years by securing 75+ healthcare centers",
  "Design an executable sales approach that demonstrates how to successfully sell the Lara System to target healthcare customers",
  "Balance clinical impact with financial sustainability while addressing stakeholder needs and adoption barriers",
];
    ...
    subCriteria: [
      {
        name: "Brand Fit",
        weight: 30,
        guide: "1 = Conflicts with brand values → 5 = Amplifies brand mission",
      },
      {
        name: "Asset Leverage",
        weight: 40,
  ...
  },
  {
    ...
    subCriteria: [
      ...
      },
      {
        ...
        weight: 30,
        guide: "1 = Requires major restructuring → 5 = Fits current structure",
      },
      {
        name: "Time to Market",
        weight: 25,
  ...
  },
  {
    ...
    subCriteria: [
      ...
      },
      {
        ...
        weight: 30,
        guide: "1 = Completely unproven model → 5 = Proven in similar contexts",
      },
      {
