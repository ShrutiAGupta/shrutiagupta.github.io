...
const BlogCard = ({ parent, post, highlight }) => {
  ...
  return (
    <div className={`${post.classes} w-full md:w-1/2 lg:w-1/3 px-4 `}>
      ...
      <div className="blog-info flex flex-wrap flex-col md:flex-row w-full">
          <img src={post.image} className="img-responsive w-full md:w-[50%]" alt={post.title} loading='lazy'/>
