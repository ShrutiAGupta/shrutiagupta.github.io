...
const PoetryCard = ({ post }) => {
  ...
  if (post.placeholder) {
    return <div className="poetry-card poetry-card--placeholder" style={gridStyle} />;
  }
  ...
  return (
    <div className="poetry-card" style={gridStyle}>
      <div className="group relative bg-white overflow-hidden w-full h-full transition-all duration-300 ease-in-out">
